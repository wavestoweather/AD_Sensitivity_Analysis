...
for i, trajectories in enumerate([ [1], [4], [7], [11], None ]):
    deriv = Deriv_dask(
        ...
        for x_axis in x_axiss:
            for ratio_type in ratio_types:
                ...
                deriv.plot_two_ds(
                    ...
                    scatter_deriv=True,
                    line_deriv=False,
                    prefix=str(i) + "_" + out_param + "_simple_" + ratio_type + "_" + x_axis + "_",
                    by="type",
                    compute=True,
                    datashade=False,
                    use_cache=cache,
                ...
                if ratio_type == "vanilla" and not x_axis == "p":
                    deriv.plot_two_ds(
                        ...
                        scatter_deriv=True,
                        line_deriv=False,
                        prefix=str(i) + "_" + out_param + "_simple_within_window_" + x_axis + "_",
                        by="type",
                        compute=True,
                        datashade=False,
                        use_cache=cache,
