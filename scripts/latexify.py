...
in_params_descr_dic = {
    ...
    "drain_s_vel": "Variance for the assumed Gaussian velocity distributions used in collection and riming processes",
    ...
    "drain_sc_coll_n": "Coefficient in graupel self collection and cloud riming",
    ...
    "drain_q_crit_c": "Riming parameter",
    "drain_d_crit_c": "Riming parameter",
    "drain_ecoll_c": "Riming coefficient",
    "drain_cap": "Coefficient for capacity of particle",
    "drain_a_ven": "Vapor deposition coefficient",
    ...
    "drain_alfa_n": "Sedimentation velocity coefficient",
    "drain_alfa_q": "Sedimentation velocity coefficient",
    "drain_lambda": "Sedimentation velocity coefficient",
    "drain_vsedi_min": "Minimum sedimentation velocity parameter",
    "drain_vsedi_max": "Maximum sedimentation velocity parameter",
    # Cloud
    ...
    "dcloud_s_vel": "Variance for the assumed Gaussian velocity distributions used in collection and riming processes",
    ...
    "dcloud_sc_coll_n": "Coefficient in graupel self collection and cloud riming",
    "dcloud_cmu0": r"Coefficient for calculating the shape parameter $\mu$",
    "dcloud_cmu1": r"Coefficient for calculating the shape parameter $\mu$",
    "dcloud_cmu2": r"Coefficient for calculating the shape parameter $\mu$",
    "dcloud_cmu3": r"Constant for calculating the shape parameter $\mu$",
    "dcloud_cmu4": r"Constant for calculating the shape parameter $\mu$",
    "dcloud_cmu5": r"Exponent for calculating the shape parameter $\mu$",
    ...
    "dcloud_g1": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_1$",
    "dcloud_g2": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_2$",
    "dcloud_mu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dcloud_nm1": "Number of bins of the incomplete gamma function lookup table 1",
    "dcloud_nm2": "Number of bins of the incomplete gamma function lookup table 2",
    "dcloud_nm3": "Number of bins of the incomplete gamma function lookup table 3",
    "dcloud_q_crit_c": "Riming parameter",
    "dcloud_d_crit_c": "Riming parameter",
    "dcloud_ecoll_c": "Riming coefficient",
    "dcloud_cap": "Coefficient for capacity of particle",
    "dcloud_a_ven": "Vapor deposition coefficient",
    ...
    "dcloud_alfa_n": "Sedimentation velocity coefficient",
    "dcloud_alfa_q": "Sedimentation velocity coefficient",
    "dcloud_lambda": "Sedimentation velocity coefficient",
    "dcloud_vsedi_min": "Minimum sedimentation velocity parameter",
    "dcloud_vsedi_max": "Maximum sedimentation velocity parameter",
    # Graupel
    ...
    "dgraupel_cmu0": r"Coefficient for calculating the shape parameter $\mu$",
    "dgraupel_cmu1": r"Coefficient for calculating the shape parameter $\mu$",
    "dgraupel_cmu2": r"Coefficient for calculating the shape parameter $\mu$",
    "dgraupel_cmu3": r"Constant for calculating the shape parameter $\mu$",
    "dgraupel_cmu4": r"Constant for calculating the shape parameter $\mu$",
    "dgraupel_cmu5": r"Exponent for calculating the shape parameter $\mu$",
    ...
    "dgraupel_nm3": "Number of bins of the incomplete gamma function lookup table 3",
    "dgraupel_q_crit_c": "Riming parameter",
    "dgraupel_d_crit_c": "Riming parameter",
    "dgraupel_ecoll_c": "Riming coefficient",
    ...
    "dhail_cmu0": r"Coefficient for calculating the shape parameter $\mu$",
    "dhail_cmu1": r"Coefficient for calculating the shape parameter $\mu$",
    "dhail_cmu2": r"Coefficient for calculating the shape parameter $\mu$",
    "dhail_cmu3": r"Constant for calculating the shape parameter $\mu$",
    "dhail_cmu4": r"Constant for calculating the shape parameter $\mu$",
    "dhail_cmu5": r"Exponent for calculating the shape parameter $\mu$",
    "dhail_alpha": "Not used",
    "dhail_beta": "Not used",
    "dhail_gamma": "Not used",
    "dhail_nu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dhail_g1": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_1$",
    "dhail_g2": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_2$",
    "dhail_mu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dhail_nm1": "Number of bins of the incomplete gamma function lookup table 1",
    "dhail_nm2": "Number of bins of the incomplete gamma function lookup table 2",
    "dhail_nm3": "Number of bins of the incomplete gamma function lookup table 3",
    "dhail_q_crit_c": "Riming parameter",
    "dhail_d_crit_c": "Riming parameter",
    "dhail_ecoll_c": "Riming coefficient",
    ...
    "dice_cmu0": r"Coefficient for calculating the shape parameter $\mu$",
    "dice_cmu1": r"Coefficient for calculating the shape parameter $\mu$",
    "dice_cmu2": r"Coefficient for calculating the shape parameter $\mu$",
    "dice_cmu3": r"Constant for calculating the shape parameter $\mu$",
    "dice_cmu4": r"Constant for calculating the shape parameter $\mu$",
    "dice_cmu5": r"Exponent for calculating the shape parameter $\mu$",
    "dice_alpha": "Not used",
    "dice_beta": "Not used",
    "dice_gamma": "Not used",
    "dice_nu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dice_g1": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_1$",
    "dice_g2": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_2$",
    "dice_mu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dice_nm1": "Number of bins of the incomplete gamma function lookup table 1",
    "dice_nm2": "Number of bins of the incomplete gamma function lookup table 2",
    "dice_nm3": "Number of bins of the incomplete gamma function lookup table 3",
    "dice_q_crit_c": "Riming parameter",
    "dice_d_crit_c": "Riming parameter",
    "dice_ecoll_c": "Riming coefficient",
    ...
    "dsnow_sc_theta_q": "Coefficient for ice collision ratio mass",
    "dsnow_sc_delta_q": "Coefficient for ice collision ratio mass",
    ...
    "dsnow_cmu0": r"Coefficient for calculating the shape parameter $\mu$",
    "dsnow_cmu1": r"Coefficient for calculating the shape parameter $\mu$",
    "dsnow_cmu2": r"Coefficient for calculating the shape parameter $\mu$",
    "dsnow_cmu3": r"Constant for calculating the shape parameter $\mu$",
    "dsnow_cmu4": r"Constant for calculating the shape parameter $\mu$",
    "dsnow_cmu5": r"Exponent for calculating the shape parameter $\mu$",
    "dsnow_alpha": "Not used",
    "dsnow_beta": "Not used",
    "dsnow_gamma": "Not used",
    "dsnow_nu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dsnow_g1": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_1$",
    "dsnow_g2": r"Right edge of incomplete gamma function,  which had been initialized with $\text{nm}_2$",
    "dsnow_mu": r"Shape parameter of the generalized $\Gamma$-distribution",
    "dsnow_nm1": "Number of bins of the incomplete gamma function lookup table 1",
    "dsnow_nm2": "Number of bins of the incomplete gamma function lookup table 2",
    "dsnow_nm3": "Number of bins of the incomplete gamma function lookup table 3",
    "dsnow_q_crit_c": "Riming parameter",
    "dsnow_d_crit_c": "Riming parameter",
    "dsnow_ecoll_c": "Riming coefficient",
...
def get_value(param):
    ...
    in_params_value_dic = {
        ...
        "dsnow_nu": 0.0, # COSMO: 0.0, SB 1.0
        "dsnow_mu": 0.5, # COSMO 0.5, SB: 1.0/3.0
        "dsnow_max_x": 2.0e-5,
        "dsnow_min_x": 1.0e-10,
