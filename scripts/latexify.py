...
json_particle_cons = ["a_geo", "b_geo", "min_x",
    ...
    "min_x_melt", "min_x_evap", "min_x_freezing",
    "min_x_depo", "min_x_collision", "min_x_collection",
    "min_x_conversion", "min_x_sedimentation", "min_x_riming",
    "max_x", "sc_theta_q", "sc_delta_q",
    "sc_theta_n", "sc_delta_n", "s_vel",
    "a_vel", "b_vel", "rho_v",
    "c_z", "sc_coll_n", "cmu0",
    "cmu1", "cmu2", "cmu3",
    "cmu4", "cmu5", "alpha",
    ...
    "g2", "mu", "nu",
    "nm1", "nm2", "nm3",
    "q_crit_c", "d_crit_c", "ecoll_c",
    "cap", "a_ven", "b_ven",
    "c_s", "a_f", "b_f",
    "alfa_n", "alfa_q", "lambda",
    "vsedi_min", "vsedi_max"]
json_particles = ["rain", "cloud", "graupel", "hail", "ice", "snow"]
json_model_cons = ["rain_gfak", "cloud_k_au", "cloud_k_sc",
    "kc_autocon", "inv_z", "dw", "q_crit_i", "D_crit_i",
    "D_conv_i", "q_crit_r", "D_crit_r", "q_crit_fr",
    "D_coll_c", "q_crit", "D_conv_sg", "D_conv_ig",
    "x_conv", "parcel_height", "alpha_spacefilling",
    "T_nuc", "T_freeze", "T_f",
    "D_eq", "rho_w", "rho_0",
    "rho_vel", "rho_vel_c", "rho_ice",
    "M_w", "M_a", "R_universal",
    "Epsilon", "gravity_acc", "R_a",
    "R_v", "a_v", "b_v",
    "a_prime", "b_prime", "c_prime",
    "K_T", "L_wd", "L_ed",
    "D_v", "ecoll_min", "ecoll_gg",
    "ecoll_gg_wet", "kin_visc_air", "C_mult",
    "T_mult_min", "T_mult_max", "T_mult_opt",
    "const0", "const3", "const4",
    "const5", "D_rainfrz_gh", "D_rainfrz_ig",
    "dv0", "p_sat_melt", "cp",
    "k_b", "a_HET", "b_HET",
    "N_sc", "n_f", "N_avo",
    "na_dust", "na_soot", "na_orga",
    "ni_het_max", "ni_hom_max", "a_dep",
    "b_dep", "c_dep", "d_dep",
    "nim_imm", "nin_dep", "alf_imm",
    "bet_dep", "bet_imm", "r_const",
    "r1_const", "cv", "p_sat_const_a",
    "p_sat_ice_const_a", "p_sat_const_b", "p_sat_ice_const_b",
    "p_sat_low_temp", "T_sat_low_temp", "alpha_depo",
    "r_0", "k_1_conv", "k_2_conv",
    "k_1_accr", "k_r", "a_ccn_1",
    "a_ccn_2", "a_ccn_3", "a_ccn_4",
    "b_ccn_1", "b_ccn_2", "b_ccn_3",
    "b_ccn_4", "c_ccn_1", "c_ccn_2",
    "c_ccn_3", "c_ccn_4", "d_ccn_1",
    "d_ccn_2", "d_ccn_3", "d_ccn_4"]
...
in_params_grouping = {
    "artificial": [
        "drain_gfak", "dcloud_k_au", "dcloud_k_sc", "dkc_autocon", "dinv_z",
        "dalpha_spacefilling", "dD_eq", "drho_vel", "drho_vel_c",
        "da_v", "db_v", "da_prime", "db_prime",
        "dc_prime", "decoll_min", "dC_mult", "dT_mult_min",
        "dT_mult_max", "dT_mult_opt", "dconst0", "dconst3",
        "dconst4", "dconst5", "da_HET", "db_HET",
        "da_dep", "db_dep", "dc_dep", "dd_dep",
        "dnim_imm", "dnin_dep", "dalf_imm", "dbet_dep",
        "dbet_imm", "dr_const", "dr1_const", "dp_sat_const_a",
        "dp_sat_ice_const_a", "dp_sat_const_b", "dp_sat_ice_const_b", "dp_sat_low_temp",
        "dT_sat_low_temp", "dalpha_depo", "dk_1_conv", "dk_2_conv",
        "dk_1_accr", "dk_r", "da_ccn_1", "da_ccn_2",
        "da_ccn_3", "da_ccn_4", "db_ccn_1", "db_ccn_2",
        "db_ccn_3", "db_ccn_4", "dc_ccn_1", "dc_ccn_2",
        "dc_ccn_3", "dc_ccn_4", "dd_ccn_1", "dd_ccn_2",
        "dd_ccn_3", "dd_ccn_4", "drain_c_z", "drain_cmu0",
        "drain_cmu1", "drain_cmu2", "drain_cmu3", "drain_cmu4",
        "drain_cmu5", "drain_g1", "drain_g2", "drain_nm1",
        "drain_nm2", "drain_nm3", "drain_a_f", "drain_b_f",
        "dcloud_c_z", "dcloud_a_f", "dcloud_b_f", "dgraupel_s_vel",
        "dgraupel_c_z", "dgraupel_sc_coll_n", "dgraupel_g1", "dgraupel_g2",
        "dgraupel_nm1", "dgraupel_nm2", "dgraupel_q_crit_c", "dgraupel_d_crit_c",
        "dgraupel_ecoll_c", "dgraupel_a_f", "dgraupel_b_f", "dhail_s_vel",
        "dhail_c_z", "dhail_sc_coll_n", "dhail_q_crit_c", "dhail_d_crit_c",
        "dhail_ecoll_c", "dhail_a_f", "dhail_b_f", "dice_sc_theta_n",
        "dice_sc_delta_n", "dice_s_vel", "dice_rho_v", "dice_c_z",
        "dice_sc_coll_n", "dice_q_crit_c", "dice_d_crit_c", "dsnow_a_geo",
        "dsnow_b_geo", "dsnow_sc_theta_n", "dsnow_sc_delta_n", "dsnow_s_vel",
        "dsnow_c_z", "dsnow_sc_coll_n", "dsnow_q_crit_c", "dsnow_d_crit_c",
        "dsnow_ecoll_c", "dsnow_a_f", "dsnow_b_f"],
    "artificial (threshold)": [
        "dq_crit_i", "dD_crit_i", "dD_conv_i", "dq_crit_r", "dD_crit_r",
        "dq_crit_fr", "dD_coll_c", "dq_crit", "dD_conv_sg",
        "dD_conv_ig", "dx_conv", "dD_rainfrz_gh", "dD_rainfrz_ig",
        "dni_het_max", "dni_hom_max", "drain_min_x", "drain_min_x_evap",
        "drain_min_x_freezing", "drain_min_x_collection", "drain_min_x_sedimentation", "drain_min_x_riming",
        "drain_max_x", "dcloud_min_x", "dcloud_min_x_act", "dcloud_min_x_freezing",
        "dcloud_min_x_conversion", "dcloud_min_x_riming", "dcloud_max_x", "dgraupel_min_x",
        "dgraupel_min_x_melt", "dgraupel_min_x_evap", "dgraupel_min_x_depo", "dgraupel_min_x_collection",
        "dgraupel_min_x_conversion", "dgraupel_min_x_sedimentation", "dgraupel_min_x_riming", "dgraupel_max_x",
        "dgraupel_vsedi_min", "dgraupel_vsedi_max", "dhail_min_x", "dhail_min_x_melt",
        "dhail_min_x_depo", "dhail_min_x_sedimentation", "dhail_min_x_riming", "dhail_max_x",
        "dhail_vsedi_min", "dhail_vsedi_max", "dice_min_x", "dice_min_x_act",
        "dice_min_x_nuc_homo", "dice_min_x_nuc_hetero", "dice_min_x_melt", "dice_min_x_evap",
        "dice_min_x_depo", "dice_min_x_collision", "dice_min_x_collection", "dice_min_x_conversion",
        "dice_min_x_sedimentation", "dice_min_x_riming", "dice_max_x", "dice_vsedi_min",
        "dice_vsedi_max", "dsnow_min_x", "dsnow_min_x_melt", "dsnow_min_x_evap",
        "dsnow_min_x_depo", "dsnow_min_x_collection", "dsnow_min_x_sedimentation", "dsnow_min_x_riming",
        "dsnow_max_x", "dsnow_vsedi_min", "dsnow_vsedi_max"],
    "physical": [
        "dw", "dparcel_height", "dT_nuc", "dT_freeze", "dT_f",
        "drho_w", "drho_0", "drho_ice", "dM_w",
        "dM_a", "dR_universal", "dEpsilon", "dgravity_acc",
        "dR_a", "dR_v", "dK_T", "dL_wd",
        "dL_ed", "dD_v", "decoll_gg", "decoll_gg_wet",
        "dkin_visc_air", "ddv0", "dp_sat_melt", "dcp",
        "dk_b", "dN_sc", "dn_f", "dN_avo",
        "dcv", "drain_rho_v", "dhail_rho_v", "dsnow_rho_v"],
    "physical (high variability)": [
        "dna_dust", "dna_soot", "dna_orga", "dr_0", "drain_a_geo",
        "drain_b_geo", "drain_a_vel", "drain_b_vel", "drain_alpha",
        "drain_beta", "drain_gamma", "drain_nu", "drain_mu",
        "drain_cap", "drain_c_s", "dcloud_a_geo", "dcloud_b_geo",
        "dcloud_a_vel", "dcloud_b_vel", "dcloud_rho_v", "dcloud_nu",
        "dcloud_mu", "dcloud_cap", "dcloud_c_s", "dgraupel_a_geo",
        "dgraupel_b_geo", "dgraupel_a_vel", "dgraupel_b_vel", "dgraupel_rho_v",
        "dgraupel_nu", "dgraupel_mu", "dgraupel_cap", "dgraupel_a_ven",
        "dgraupel_c_s", "dgraupel_alfa_n", "dgraupel_alfa_q", "dgraupel_lambda",
        "dhail_a_geo", "dhail_b_geo", "dhail_a_vel", "dhail_b_vel",
        "dhail_nu", "dhail_mu", "dhail_cap", "dhail_a_ven",
        "dhail_c_s", "dhail_alfa_n", "dhail_alfa_q", "dhail_lambda",
        "dice_a_geo", "dice_b_geo", "dice_a_vel", "dice_b_vel",
        "dice_nu", "dice_mu", "dice_ecoll_c", "dice_cap",
        "dice_a_ven", "dice_c_s", "dice_a_f", "dice_b_f",
        "dice_alfa_n", "dice_alfa_q", "dice_lambda", "dsnow_a_vel",
        "dsnow_b_vel", "dsnow_nu", "dsnow_mu", "dsnow_cap",
        "dsnow_a_ven", "dsnow_c_s", "dsnow_alfa_n", "dsnow_alfa_q",
        "dsnow_lambda"],
    "1-moment": [
        "da_1", "da_2", "de_1", "de_2", "dd",
        "dN_c", "dgamma", "dbeta_c", "dbeta_r",
        "ddelta1", "ddelta2", "dzeta"]}
...
in_params_numeric_value_dic = {
    ...
    "dd_scale": 0.0147626,
    "dScaling factor": 1,
    "dd_ccn_4": 3.60849e+08,
    "dd_ccn_3": 0.890749,
    "dd_ccn_2": 0.625881,
    "dd_ccn_1": 2.87736e+08,
    "dc_ccn_1": 16.242,
    ...
    "db_prime": 9.8,
    "dinv_z": 0.004,
    "dkc_autocon": 9.44e+09,
    "dcloud_k_sc": 1.888e+10,
    "dcloud_k_au": 1.45231e+19,
    "drain_gfak": 1,
    "dbet_imm": 1.2044,
    "dzeta": 1.125,
    "ddelta2": 0.6875,
