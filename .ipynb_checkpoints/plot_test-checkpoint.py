...
#         min_x=90000,
#         max_x=44755,
        plot_path="pics/test13_ds_" + key + "_",
        fig_type="png",
        **kwargs
    )
    t2 = timer()
...
#         min_x=90000,
#         max_x=44755,
        plot_path="pics/test14_ds_" + key + "_",
        fig_type="png",
        **kwargs
    )
    t2 = timer()
...
#         min_x=90000,
#         max_x=44755,
        plot_path="pics/perc_mapped_" + key + "_",
        **kwargs
    )
    t2 = timer()
    print("Plot two (p) done in {}s\n".format(t2-t))
...
#         min_x=34750,
#         max_x=44755,
        plot_path="pics/new_hist_" + key + "_",
        **kwargs
    )
    t2 = timer()
    print("Plot two (p) done in {}s\n".format(t2-t))